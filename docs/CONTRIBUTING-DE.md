# Beiträge zu HesabDesk

HesabDesk begrüßt Beiträge von jedem. Hier sind die Richtlinien, wenn Sie uns
helfen möchten:

## Beiträge

Beiträge zu HesabDesk oder seinen Abhängigkeiten sollten in Form von Pull
...
- Wenn Ihr Patch nicht begutachtet wird oder Sie eine bestimmte Person zur
  ...
  per [E-Mail](mailto:info@hesabdesk.com) um eine Begutachtung bitten.
...
HesabDesk-Mitarbeiter arbeiten häufig im [Discord](https://discord.gg/nDceKgxnkV).
