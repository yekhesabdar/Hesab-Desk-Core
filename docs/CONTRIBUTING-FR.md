...
# Contribuer à HesabDesk

HesabDesk accueille les contributions de tous. Voici les directives si vous
envisagez de nous aider :

## Contributions

Les contributions à HesabDesk ou à ses dépendances doivent être soumises sous
...
- Si votre correctif n'est pas examiné ou si vous avez besoin qu'une personne
  ...
  revue par [e-mail](mailto:info@hesabdesk.com).
...
Les contributeurs de HesabDesk se retrouvent fréquemment sur
