...
<p align="center">
  ...
  <b>README, <a href="https://github.com/rustdesk/rustdesk/tree/master/src/lang">HesabDesk UI</a> ve <a href="https://github.com/rustdesk/doc.hesabdesk.com">HesabDesk Dökümantasyonu</a>'nu ana dilinize çevirmemiz için yardımınıza ihtiyacımız var</b>
</p>
...
- **[src/rendezvous_mediator.rs](https://github.com/rustdesk/rustdesk/tree/master/src/rendezvous_mediator.rs)**: [hesabdesk-server](https://github.com/rustdesk/rustdesk-server) ile iletişime gir, remote direct(TCP delik açma) yada relay bağlantısı için bekle
