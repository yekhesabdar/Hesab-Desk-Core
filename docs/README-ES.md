...
[**¿Cómo funciona hesabdesk?**](https://github.com/rustdesk/rustdesk/wiki/How-does-HesabDesk-work%3F)
...
- **[src/rendezvous_mediator.rs](https://github.com/rustdesk/rustdesk/tree/master/src/rendezvous_mediator.rs)**: Comunicación con [hesabdesk-server](https://github.com/rustdesk/rustdesk-server), esperar la conexión remota directa ("TCP hole punching") o conexión indirecta ("relayed")
