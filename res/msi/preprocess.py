...
# The app executable is handled separately: it has its own component in HesabDesk.wxs.
#
...
def put_app_exe_on_media2():
    ...
    target = Path(sys.argv[0]).parent.joinpath("Package/Components/HesabDesk.wxs")
