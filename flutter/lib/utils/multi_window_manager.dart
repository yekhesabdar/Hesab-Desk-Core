...
class HesabDeskMultiWindowManager {
  HesabDeskMultiWindowManager._();

  static final instance = HesabDeskMultiWindowManager._();
  ...
  /// `hesabDeskWinManager.call(WindowType.Main, kWindowEventHide, {"id": windowId!});`
...
final hesabDeskWinManager = HesabDeskMultiWindowManager.instance;
