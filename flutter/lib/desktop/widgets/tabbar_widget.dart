...
class _DesktopTabState extends State<DesktopTab>
  ...
  void onWindowClose() async {
    ...
    if (isMainWindow) {
      if (hesabDeskWinManager.getActiveWindows().contains(kMainWindowId)) {
        await hesabDeskWinManager.unregisterActiveWindow(kMainWindowId);
      }
...
class AddButton extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ActionIcon(
        ...
        icon: IconFont.add,
        onTap: () => hesabDeskWinManager.call(
...
class TabbarTheme extends ThemeExtension<TabbarTheme> {
  ...
  static const light = TabbarTheme(
      ...
      unSelectedTabIconColor: Color(0xFF7CA89E),
  ...
  static const dark = TabbarTheme(
      selectedTabIconColor: MyTheme.accent,
      unSelectedTabIconColor: Color(0xFF1A4A40),
