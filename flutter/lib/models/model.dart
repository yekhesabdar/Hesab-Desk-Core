...
class FfiModel with ChangeNotifier {
  ...
  handlePlatformAdditions(
    ...
    if (updateData.isEmpty) {
      _pi.platformAdditions.remove(kPlatformAdditionsHesabDeskVirtualDisplays);
      ...
      try {
        ...
        if (!updateJson
            .containsKey(kPlatformAdditionsHesabDeskVirtualDisplays)) {
          _pi.platformAdditions
              .remove(kPlatformAdditionsHesabDeskVirtualDisplays);
        }
  ...
  void setViewOnly(String id, bool value) {
    ...
    // tmp fix for https://github.com/hesabdesk/hesabdesk/pull/3706#issuecomment-1481242389
  ...
  void edgeScrollMouse(double x, double y) async {
    ...
    if (encroachment.length2 == 0) {
      ...
      var bumpMouseSucceeded = _bumpMouseIsWorking &&
          (await hesabDeskWinManager.call(WindowType.Main, kWindowBumpMouse,
...
class PeerInfo with ChangeNotifier {
  ...
  List<int> get HesabDeskVirtualDisplays => List<int>.from(
      platformAdditions[kPlatformAdditionsHesabDeskVirtualDisplays] ?? []);
  ...
  bool get isHesabDeskIdd =>
      platformAdditions[kPlatformAdditionsIddImpl] == 'hesabdesk_idd';
