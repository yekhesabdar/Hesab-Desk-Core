...
#
# Script to build F-Droid release of HesabDesk
#
# Copyright (C) 2024, The HesabDesk Authors
...
#
# - versionName from https://github.com/hesabdesk/hesabdesk/releases/download/fdroid-version/hesabdesk-version.txt
# - versionCode from https://github.com/hesabdesk/hesabdesk/releases/download/fdroid-version/hesabdesk-version.txt
...
arm64-v8a)
	...
	HESABDESK_FEATURES='flutter,hwcodec'
	;;
armeabi-v7a)
...
prebuild)
	...
	# Flutter used to compile main Hesabdesk library
	...
	# Install Flutter version for HesabDesk library build
...
build)
	...
	cargo ndk \
		...
		build \
		--release \
		--features "${HESABDESK_FEATURES}"

	mkdir -p "flutter/android/app/src/main/jniLibs/${ANDROID_ABI}"

	cp "target/${RUST_TARGET}/release/liblibhesabdesk.so" \
		"flutter/android/app/src/main/jniLibs/${ANDROID_ABI}/libhesabdesk.so"
