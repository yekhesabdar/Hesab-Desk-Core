...
pub const WIN_TOPMOST_INJECTED_PROCESS_EXE: &'static str = "RuntimeBroker_hesabdesk.exe";
pub const INJECTED_PROCESS_EXE: &'static str = WIN_TOPMOST_INJECTED_PROCESS_EXE;
pub(super) const PRIVACY_WINDOW_CLASS: &'static str = "HesabDeskPrivacyWindowClass";
pub(super) const PRIVACY_WINDOW_NAME: &'static str = "HesabDeskPrivacyWindow";
...
const WM_HESABDESK_SHOW_WINDOWS: u32 = WM_APP + 3;
const WM_HESABDESK_HIDE_WINDOWS: u32 = WM_APP + 4;
...
fn set_privacy_windows_visible(hwnds: &[HWND], show: bool) -> ResultType<usize> {
    ...
    let message = if show {
        WM_HESABDESK_SHOW_WINDOWS
    } else {
        WM_HESABDESK_HIDE_WINDOWS
    };
    let mut posted = 0;
