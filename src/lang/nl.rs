...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("config_acc", "Om uw apparaat op afstand te kunnen bedienen, moet u HesabDesk toestemming voor Toegankelijkheid geven."),
        ("config_screen", "Om uw apparaat op afstand te kunnen bedienen, moet u HesabDesk toestemming voor Schermopname geven."),
