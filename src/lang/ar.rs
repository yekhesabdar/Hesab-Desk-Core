...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "جاري الاتصال بشبكة HesabDesk..."),
        ...
        ("install_tip", "بسبب صلاحيات تحكم حساب المستخدم. HesabDesk قد لا يعمل بشكل صحيح في جهة البعيد في بعض الحالات. لتفادي ذلك. الرجاء الضغط على الزر ادناه لتثبيت HesabDesk في جهازك."),
        ("Click to upgrade", "اضغط للارتقاء"),
        ("Configure", "تهيئة"),
        ("config_acc", "لتتمكن من التحكم بسطح مكتبك البعيد, تحتاج الى منح HesabDesk اذونات \"امكانية الوصول\"."),
        ("config_screen", "لتتمكن من الوصول الى سطح مكتبك البعيد, تحتاج الى منح HesabDesk اذونات \"تسجيل الشاشة\"."),
        ...
        ("android_input_permission_tip1", "لكي يتمكن جهاز بعيد من التحكم بجهازك الـ Android عن طريق الفارة أو اللمس، يلزمك السماح لـ HesabDesk باستخدام خدمة \"إمكانية الوصول\"."),
        ("android_input_permission_tip2", "يرجى الانتقال إلى صفحة إعدادات النظام التالية، والعثور على [الخدمات المثبتة]، وتشغيل خدمة [HesabDesk Input]."),
        ...
        ("Turned off", "مطفئ"),
        ("Language", "اللغة"),
        ("Keep HesabDesk background service", "ابق خدمة HesabDesk تعمل في الخلفية"),
        ("Ignore Battery Optimizations", "تجاهل تحسينات البطارية"),
        ("android_open_battery_optimizations_tip", "اذا اردت تعطيل هذه الميزة, الرجاء الذهاب الى صفحة اعدادات تطبيق HesabDesk, ابحث عن البطارية, الغ تحديد غير مقيد"),
        ...
        ("config_input", "لتتمكن من التحكم بسطح المكتب البعيد. يجب من HesabDesk اذونات \"مراقبة المدخلات\"."),
        ("config_microphone", "لتتمكن من التحدث. يجب منح HesabDesk اذونات \"تسجيل الصوت\"."),
        ...
        ("still_click_uac_tip", "لازال يحتاج المستخدم البعيد للضغط على موافق في نافذة تحكم حساب المستخدم في HesabDesk الذي يعمل."),
        ...
        ("View Mode", "وضع العرض"),
        ("verify_hesabdesk_password_tip", "تحقق من كلمة مرور HesabDesk"),
        ...
        ("upgrade_hesabdesk_server_pro_to_{}_tip", "ترقية خادم HesabDesk Pro إلى {}"),
        ...
        ("enable-bot-tip", "تمكين البوت للتفاعل مع HesabDesk"),
        ...
        ("upgrade_remote_hesabdesk_client_to_{}_tip", "ترقية عميل HesabDesk البعيد إلى {}"),
        ...
        ("HesabDesk cannot reach the desktop session on the remote device, check that a desktop session is running and that HesabDesk can use it", "يتعذّر على HesabDesk الوصول إلى جلسة سطح المكتب على الجهاز البعيد، تأكد من أن جلسة سطح المكتب تعمل وأن HesabDesk يمكنه استخدامها"),
        ...
        ("HesabDesk could not obtain a usable screen from the XDG Desktop Portal, the PipeWire library may be too old", "تعذّر على HesabDesk الحصول على شاشة قابلة للاستخدام من XDG Desktop Portal، قد تكون مكتبة PipeWire قديمة جدًا"),
        ("HesabDesk could not load a GStreamer component needed for screen capture ({})", "تعذّر على HesabDesk تحميل مكوّن GStreamer اللازم لالتقاط الشاشة ({})"),
