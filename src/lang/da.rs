...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Opretter forbindelse til HesabDesk-netværket..."),
        ...
        ("install_tip", "På grund af UAC kan HesabDesk ikke fungere korrekt i nogle tilfælde på fjernskrivebordet. For at undgå UAC skal du klikke på knappen nedenfor for at installere HesabDesk på systemet"),
        ("Click to upgrade", "Klik for at opgradere"),
        ("Configure", "Konfigurer"),
        ("config_acc", "For at kontrollere dit skrivebord på afstand skal du give HesabDesk \"Access \" Rettigheder."),
        ("config_screen", "For at kunne få adgang til dit skrivebord langtfra, skal du give HesabDesk \"skærmstøtte \" tilladelser."),
        ...
        ("android_input_permission_tip1", "For at en ekstern enhed kan kontrollere din Android-enhed via mus eller berøring, skal du give HesabDesk mulighed for at bruge tjenesten \"tilgængelighed \"."),
        ("android_input_permission_tip2", "Gå til den næste systemindstillingsside, søg og indtast [installerede tjenester], tænd for [HesabDesk Input] tjenesten."),
        ...
        ("Turned off", "Slukket"),
        ("Language", "Sprog"),
        ("Keep HesabDesk background service", "Behold HesabDesk baggrundstjeneste"),
        ("Ignore Battery Optimizations", "Ignorér betteri optimeringer"),
        ("android_open_battery_optimizations_tip", "Hvis du ønsker at slukke for denne funktion, åbn HesabDesk appens indstillinger, tryk på [Batteri], og fjern flueben ved [Uden begrænsninger]"),
        ...
        ("software_render_tip", "Hvis du bruger et Nvidia-grafikkort på Linux, og fjernskrivebordsvinduet lukker ned med det samme efter forbindelsen er oprettet, kan det hjælpe at skifte til Nouveau open source-driveren, og aktivere software-rendering. En genstart af HesabDesk er nødvendig."),
        ("Always use software rendering", "Brug altid software-rendering"),
        ("config_input", "For at styre fjernskrivebordet med tastaturet, skal du give Hesabdesk rettigheder til at optage tastetryk"),
        ("config_microphone", "For at tale sammen over fjernstyring, skal du give HesabDesk rettigheder til at optage lyd"),
        ...
        ("still_click_uac_tip", "Kræver stadigvæk at fjernbrugeren skal trykke OK på UAC-vinduet ved kørsel af HesabDesk."),
        ...
        ("verify_hesabdesk_password_tip", "Bekræft HesabDesk-adgangskode"),
        ...
        ("scam_text1", "Hvis du taler telefon med en person du IKKE kender, og IKKE stoler på, som har bedt dig om at bruge HesabDesk til at forbinde til din PC, så stop med det samme, og læg på omgående."),
        ...
        ("upgrade_hesabdesk_server_pro_to_{}_tip", "Opgradér venligst HesabDesk Server Pro til version {} eller nyere!"),
        ...
        ("selinux_tip", "SELinux er aktiveret på din enhed, hvilket kan forhindre HesabDesk i at køre normalt."),
        ...
        ("powered_by_me", "Drives af HesabDesk"),
        ...
        ("preset_password_warning", "Denne brugertilpassede udgave har en forudbestemt adgangskode. Alle der kender til denne adgangskode, kan få fuld adgang til din enhed. Hvis du ikke forventede dette, bør du afinstallere denne udgave af HesabDesk med det samme."),
        ...
        ("allow-only-conn-window-open-tip", "Tillad kun fjernforbindelser hvis HesabDesk-vinduet er synligt"),
        ...
        ("floating_window_tip", "Det hjælper til at holde HesabDesk-baggrundstjenesten kørende"),
        ...
        ("upgrade_remote_hesabdesk_client_to_{}_tip", "Opgrader venligst HesabDesk-klienten til version {} eller nyere på fjernsiden!"),
        ...
        ("allow-insecure-tls-fallback-tip", "Som standard verificerer HesabDesk servercertifikatet for protokoller, der bruger TLS.\nNår denne indstilling er aktiveret, vil HesabDesk springe verificeringstrinnet over og fortsætte, hvis verificeringen mislykkes."),
        ("Disable UDP", "Deaktivér UDP"),
        ("disable-udp-tip", "Bestemmer, om der kun skal bruges TCP.\nNår denne indstilling er aktiveret, vil HesabDesk ikke længere bruge UDP 21116; i stedet bruges TCP 21116."),
        ("server-oss-not-support-tip", "BEMÆRK: HesabDesk Server OSS indeholder ikke denne funktion."),
        ...
        ("HesabDesk cannot reach the desktop session on the remote device, check that a desktop session is running and that HesabDesk can use it", "HesabDesk kan ikke nå skrivebordssessionen på fjernenheden, kontrollér at en session kører, og at HesabDesk kan bruge den"),
        ...
        ("HesabDesk could not obtain a usable screen from the XDG Desktop Portal, the PipeWire library may be too old", "HesabDesk kunne ikke få en brugbar skærm fra XDG Desktop Portal, PipeWire-biblioteket er måske for gammelt"),
        ("HesabDesk could not load a GStreamer component needed for screen capture ({})", "HesabDesk kunne ikke indlæse en GStreamer-komponent, der kræves til skærmoptagelse ({})"),
