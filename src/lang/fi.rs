...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Yhdistetään HesabDesk verkkoon..."),
        ...
        ("install_tip", "Joissain tapauksissa HesabDesk ei toimi oikein etäpuolella UAC:n vuoksi. Välttääksesi tämän, napsauta alla olevaa painiketta asentaaksesi HesabDeskin järjestelmään."),
        ("Click to upgrade", "Päivitä napsauttamalla"),
        ("Configure", "Määritä"),
        ("config_acc", "Etätyöpöydän hallintaa varten sinun on annettava HesabDeskille ”Esteettömyys”-oikeudet."),
        ("config_screen", "Etätyöpöydän käyttöä varten sinun on annettava HesabDeskille ”Näytön tallennus” oikeudet."),
        ...
        ("Discovered", "Löydetty"),
        ("install_daemon_tip", "Palvelun automaattista käynnistystä varten HesabDesk daemon on asennettava järjestelmään."),
        ("Remote ID", "Etätunnus"),
        ("Paste", "Liitä"),
        ...
        ("android_input_permission_tip1", "Siirry Androidin asetuksiin ja ota HesabDeskille käyttöön 'Syötteen ohjaus' oikeus."),
        ("android_input_permission_tip2", "Jos et löydä asetusta, etsi 'Esteettömyys' ja salli HesabDesk ohjelman käyttö."),
        ("android_new_connection_tip", "Uusi yhteyspyyntö vastaanotettu."),
        ("android_service_will_start_tip", "HesabDesk palvelu käynnistyy taustalla."),
        ("android_stop_service_tip", "Pysäytä taustapalvelu tarvittaessa HesabDeskin asetuksista."),
        ("android_version_audio_tip", "Äänensiirto vaatii Android 10:n tai uudemman."),
        ("android_start_service_tip", "HesabDesk palvelu käynnistetään..."),
        ...
        ("Language", "Kieli"),
        ("Keep HesabDesk background service", "Pidä HesabDeskin taustapalvelu käynnissä"),
        ("Ignore Battery Optimizations", "Ohita akun optimoinnit"),
        ("android_open_battery_optimizations_tip", "Poista HesabDeskin akkuoptimointi, jotta yhteys pysyy vakaana taustalla."),
        ...
        ("Show HesabDesk", "Näytä HesabDesk"),
        ...
        ("verify_hesabdesk_password_tip", "Vahvista HesabDesk salasanasi kirjautumista varten"),
        ...
        ("scam_text2", "HesabDesk ei koskaan pyydä maksua tai etäkäyttöä ilman lupaasi."),
        ...
        ("upgrade_hesabdesk_server_pro_to_{}_tip", "Päivitä HesabDesk Server Pro versioon {} jatkaaksesi."),
        ...
        ("About HesabDesk", "Tietoa HesabDeskistä"),
        ...
        ("upgrade_remote_hesabdesk_client_to_{}_tip", "Päivitä etä-HesabDesk-asiakasversioon {} yhteensopivuuden takaamiseksi"),
        ...
        ("allow-insecure-tls-fallback-tip", "Oletuksena HesabDesk vahvistaa palvelimen varmenteen TLS:ää käyttävissä protokollissa.\nKun tämä asetus on käytössä, HesabDesk ohittaa vahvistusvaiheen ja jatkaa toimintaa, jos vahvistus epäonnistuu."),
        ("Disable UDP", "Poista UDP käytöstä"),
        ("disable-udp-tip", "Määrittää, käytetäänkö vain TCP:tä.\nKun tämä asetus on käytössä, HesabDesk ei enää käytä UDP-porttia 21116, vaan sen sijaan käytetään TCP-porttia 21116."),
        ("server-oss-not-support-tip", "HUOMAUTUS: HesabDesk-palvelimen OSS ei sisällä tätä ominaisuutta."),
        ...
        ("HesabDesk cannot reach the desktop session on the remote device, check that a desktop session is running and that HesabDesk can use it", "HesabDesk ei tavoita etälaitteen työpöytäistuntoa, tarkista että istunto on käynnissä ja että HesabDesk voi käyttää sitä"),
        ...
        ("HesabDesk could not obtain a usable screen from the XDG Desktop Portal, the PipeWire library may be too old", "HesabDesk ei saanut XDG Desktop Portalilta käyttökelpoista näyttöä, PipeWire-kirjasto voi olla liian vanha"),
        ("HesabDesk could not load a GStreamer component needed for screen capture ({})", "HesabDesk ei voinut ladata näytön kaappaukseen tarvittavaa GStreamer-osaa ({})"),
