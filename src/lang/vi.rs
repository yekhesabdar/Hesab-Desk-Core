...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Đang kết nối đến mạng lưới HesabDesk..."),
        ...
        ("install_tip", "Do cơ chế UAC, HesabDesk có thể không hoạt động ổn định ở phía người dùng từ xa trong một số trường hợp. Để tránh vấn đề này, vui lòng nhấn nút bên dưới để cài đặt HesabDesk vào hệ thống."),
        ("Click to upgrade", "Nhấn để nâng cấp"),
        ("Configure", "Cấu hình"),
        ("config_acc", "Để điều khiển từ xa, bạn cần cấp quyền \"Trợ năng\" cho HesabDesk."),
        ("config_screen", "Để truy cập từ xa, bạn cần cấp quyền \"Ghi màn hình\" cho HesabDesk."),
        ...
        ("android_input_permission_tip2", "Vui lòng tìm [Dịch vụ đã cài đặt] trong cài đặt và bật [HesabDesk Input]."),
        ...
        ("Turned off", "Đã tắt"),
        ("Language", "Ngôn ngữ"),
        ("Keep HesabDesk background service", "Giữ dịch vụ HesabDesk chạy nền"),
        ...
        ("verify_hesabdesk_password_tip", "Xác thực mật khẩu HesabDesk"),
        ...
        ("scam_text2", "Chỉ sử dụng HesabDesk với những người bạn thực sự tin tưởng."),
        ...
        ("upgrade_hesabdesk_server_pro_to_{}_tip", "Nâng cấp lên Pro để có thêm tính năng"),
        ...
        ("allow-only-conn-window-open-tip", "Chỉ cho phép khi cửa sổ HesabDesk mở"),
        ...
        ("floating_window_tip", "Giữ HesabDesk trên cùng"),
        ...
        ("upgrade_remote_hesabdesk_client_to_{}_tip", "Vui lòng nâng cấp đối tác lên {}"),
        ...
        ("HesabDesk cannot reach the desktop session on the remote device, check that a desktop session is running and that HesabDesk can use it", "HesabDesk không thể truy cập phiên màn hình nền trên thiết bị từ xa, hãy kiểm tra rằng một phiên đang chạy và HesabDesk có thể dùng nó"),
        ...
        ("HesabDesk could not obtain a usable screen from the XDG Desktop Portal, the PipeWire library may be too old", "HesabDesk không lấy được màn hình dùng được từ XDG Desktop Portal, thư viện PipeWire có thể quá cũ"),
        ("HesabDesk could not load a GStreamer component needed for screen capture ({})", "HesabDesk không thể tải một thành phần GStreamer cần cho việc ghi màn hình ({})"),
