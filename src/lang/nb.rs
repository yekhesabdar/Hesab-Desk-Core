...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Opretter tilkobling til HesabDesk-nettverket..."),
        ...
        ("install_tip", "På grunn av UAC kan HesabDesk ikke fungere korrekt i enkelte tillfeller på fjernskrivebordet. For å unngå UAC klikker du på knappen nedenfor for å installere HesabDesk på systemet"),
        ("Click to upgrade", "Klikk for å oppgradere"),
        ("Configure", "Konfigurer"),
        ("config_acc", "For å kontrollere ditt skrivebord med fjernstyring må du gi HesabDesk \"Access \" Rettigheter."),
        ("config_screen", "For å kunne få adgang til ditt skrivebord med fjernstyring, må du gi HesabDesk \"skjerstøtte \" tillatelser."),
        ...
        ("android_input_permission_tip1", "For at en ekstern enhet kan kontrollere din Android-enhet via mus eller berøring, må du gi HesabDesk mulighet til å bruke tjenesten \"tilgjengelighet \"."),
        ("android_input_permission_tip2", "Gå til den neste systeminnstillingssiden, søk og tast inn [installerte tjenester], aktiver [HesabDesk Input] tjenesten."),
        ...
        ("android_open_battery_optimizations_tip", "Hvis du vil deaktivere denne funksjonen, gå til neste innstillingsside for HesabDesk-applikasjonen, finn og åpne [Batteri], og fjern haken ved [Ubegrenset]."),
        ...
        ("config_input", "For å kunne styre fjernskrivebordet med tastatur må du gi HesabDesk tillatelsen \"Inndataovervåking\"."),
        ("config_microphone", "For å kunne snakke eksternt må du gi HesabDesk tillatelsen \"Ta opp lyd\"."),
        ...
        ("still_click_uac_tip", "Krever fortsatt at fjernbrukeren klikker OK på UAC-vinduet til den kjørende HesabDesk."),
        ...
        ("verify_hesabdesk_password_tip", "Verifiser HesabDesk-passord"),
        ...
        ("scam_text1", "Hvis du snakker i telefonen med noen du IKKE kjenner OG STOLER PÅ, som har bedt deg om å bruke HesabDesk og starte tjenesten, ikke fortsett og legg på umiddelbart."),
        ...
        ("upgrade_hesabdesk_server_pro_to_{}_tip", "Vennligst oppgrader HesabDesk Server Pro til versjon {} eller nyere!"),
        ...
        ("selinux_tip", "SELinux er aktivert på enheten din, noe som kan hindre HesabDesk i å fungere som det skal på den kontrollerte siden."),
        ...
        ("powered_by_me", "Drevet av HesabDesk"),
        ...
        ("allow-only-conn-window-open-tip", "Tillat kun tilkobling hvis HesabDesk-vinduet er åpent"),
        ...
        ("floating_window_tip", "Det bidrar til å holde HesabDesk-bakgrunnstjenesten i gang"),
        ...
        ("upgrade_remote_hesabdesk_client_to_{}_tip", "Vennligst oppgrader HesabDesk-klienten til versjon {} eller nyere på fjernsiden!"),
        ...
        ("allow-insecure-tls-fallback-tip", "Som standard verifiserer HesabDesk serversertifikatet for protokoller som bruker TLS.\nMed dette alternativet aktivert vil HesabDesk falle tilbake til å hoppe over verifiseringstrinnet og fortsette ved verifiseringsfeil."),
        ("Disable UDP", "Deaktiver UDP"),
        ("disable-udp-tip", "Styrer om kun TCP skal brukes.\nNår dette alternativet er aktivert, vil HesabDesk ikke lenger bruke UDP 21116, TCP 21116 brukes i stedet."),
        ("server-oss-not-support-tip", "MERK: HesabDesk server OSS inkluderer ikke denne funksjonen."),
        ...
        ("HesabDesk cannot reach the desktop session on the remote device, check that a desktop session is running and that HesabDesk can use it", "HesabDesk får ikke tilgang til skrivebordsøkten på den eksterne enheten, kontroller at en økt kjører og at HesabDesk kan bruke den"),
        ...
        ("HesabDesk could not obtain a usable screen from the XDG Desktop Portal, the PipeWire library may be too old", "HesabDesk fikk ingen brukbar skjerm fra XDG Desktop Portal, PipeWire-biblioteket kan være for gammelt"),
        ("HesabDesk could not load a GStreamer component needed for screen capture ({})", "HesabDesk kunne ikke laste en GStreamer-komponent som kreves for skjermopptak ({})"),
