...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Ready", "Hazır"),
        ("Established", "Quruldu"),
        ("connecting_status", "HesabDesk şəbəkəsinə qoşulur..."),
        ...
        ("install_tip", "UAC səbəbindən HesabDesk bəzi hallarda uzaq tərəf kimi düzgün işləyə bilmir. UAC-dan yayınmaq üçün aşağıdakı düyməyə basaraq HesabDesk-i sistemə quraşdırın."),
        ("Click to upgrade", "Yeniləmək üçün klikləyin"),
        ("Configure", "Konfiqurasiya et"),
        ("config_acc", "Masaüstünüzü uzaqdan idarə etmək üçün HesabDesk-ə \"Əlçatanlıq\" icazələrini verməlisiniz."),
        ("config_screen", "Masaüstünüzə uzaqdan giriş üçün HesabDesk-ə \"Ekran Yazısı\" icazələrini verməlisiniz."),
        ...
        ("android_input_permission_tip1", "Uzaq cihazın siçan və ya toxunuşla Android cihazınızı idarə etməsi üçün HesabDesk-ə \"Əlçatanlıq\" xidmətindən istifadə icazəsi verməlisiniz."),
        ("android_input_permission_tip2", "Növbəti sistem parametrləri səhifəsinə keçin, [Quraşdırılmış xidmətlər] bölməsini tapıb açın və [HesabDesk Input] xidmətini işə salın."),
        ...
        ("Language", "Dil"),
        ("Keep HesabDesk background service", "HesabDesk fon xidmətini işlək saxla"),
        ("Ignore Battery Optimizations", "Batareya optimallaşdırmalarını nəzərə alma"),
        ("android_open_battery_optimizations_tip", "Bu funksiyanı söndürmək istəyirsinizsə, növbəti HesabDesk tətbiq parametrləri səhifəsinə keçin, [Batareya] bölməsini tapıb açın və [Məhdudiyyətsiz] seçimini götürün"),
        ...
        ("Show HesabDesk", "HesabDesk-i göstər"),
        ("This PC", "Bu kompüter"),
        ("or", "və ya"),
        ...
        ("config_input", "Uzaq masaüstünü klaviatura ilə idarə etmək üçün HesabDesk-ə \"Giriş Monitorinqi\" icazələrini verməlisiniz."),
        ("config_microphone", "Uzaqdan danışmaq üçün HesabDesk-ə \"Audio Yazısı\" icazələrini verməlisiniz."),
        ...
        ("still_click_uac_tip", "Yenə də uzaq istifadəçinin işləyən HesabDesk-in UAC pəncərəsində OK düyməsini basması tələb olunur."),
        ...
        ("verify_hesabdesk_password_tip", "HesabDesk parolunu doğrula"),
        ...
        ("scam_text1", "Tanımadığınız və ETİBAR ETMƏDİYİNİZ biri telefonda sizdən HesabDesk işlətməyi və xidməti başlatmağı xahiş edirsə, davam etməyin və dərhal telefonu bağlayın."),
        ...
        ("upgrade_hesabdesk_server_pro_to_{}_tip", "HesabDesk Server Pro-nu {} və ya daha yeni versiyaya yüksəldin!"),
        ...
        ("selinux_tip", "Cihazınızda SELinux aktivdir, bu, HesabDesk-in idarə olunan tərəf kimi düzgün işləməsinə mane ola bilər."),
        ...
        ("powered_by_me", "HesabDesk ilə işləyir"),
        ...
        ("allow-only-conn-window-open-tip", "Əlaqəyə yalnız HesabDesk pəncərəsi açıq olduqda icazə ver"),
        ...
        ("floating_window_tip", "HesabDesk fon xidmətini işlək saxlamağa kömək edir"),
        ...
        ("About HesabDesk", "HesabDesk haqqında"),
        ...
        ("upgrade_remote_hesabdesk_client_to_{}_tip", "Uzaq tərəfdə HesabDesk klientini {} və ya daha yeni versiyaya yüksəldin!"),
        ...
        ("allow-insecure-tls-fallback-tip", "Standart olaraq HesabDesk TLS işlədən protokollar üçün server sertifikatını yoxlayır.\nBu seçim aktiv olduqda, yoxlama alınmadığı halda HesabDesk yoxlama addımını keçib davam edəcək."),
        ("Disable UDP", "UDP-ni söndür"),
        ("disable-udp-tip", "Yalnız TCP işlədilib işlədilməyəcəyini idarə edir.\nBu seçim aktiv olduqda HesabDesk artıq UDP 21116 işlətməyəcək, əvəzində TCP 21116 işlədiləcək."),
        ("server-oss-not-support-tip", "QEYD: HesabDesk server OSS bu funksiyanı əhatə etmir."),
        ...
        ("HesabDesk cannot reach the desktop session on the remote device, check that a desktop session is running and that HesabDesk can use it", ""),
        ...
        ("HesabDesk could not obtain a usable screen from the XDG Desktop Portal, the PipeWire library may be too old", ""),
