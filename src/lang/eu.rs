...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "HesabDesk sarera konektatzen..."),
        ...
        ("install_tip", "Erabiltzaile Kontuen Kontrolarengatik, HesabDesk ezin du ondo funtzionatu urruneko mahaigainean. EKK saihesteko, mesedez, egin klik azpiko botoian HesabDesk sistema mailan instalatzeko."),
        ("Click to upgrade", "Egin klik bertsio-berritzeko"),
        ("Configure", "Konfiguratu"),
        ("config_acc", "Zure mahaigaina urrunetik kontrolatzeko, HesabDesk-i \"Irisgarritasuna\" baimenak eman behar dituzu."),
        ("config_screen", "Zure mahaigaina kanpotik kontrolatzeko, HesabDesk-i \"Pantaila grabatu\" baimena eman behar duzu."),
        ...
        ("android_input_permission_tip1", "Urruneko gailu batek zure Android gailua saguaren edo ukipenaren bidez kontrolatzeko, HesabDesk \"Irisgarritasuna\" zerbitzua erabiltzeko baimena eman behar diozu."),
        ("android_input_permission_tip2", "Joan hurrengo irekiko den sistemaren konfigurazio orrira, bilatu eta sartu [Instalatutako zerbitzuak], aktibatu [HesabDesk Input] zerbitzua."),
        ...
        ("Turned off", "Itzalita"),
        ("Language", "Hizkuntza"),
        ("Keep HesabDesk background service", "Mantendu HesabDesk atzeko planoko zerbitzu bezala"),
        ("Ignore Battery Optimizations", "Ezikusi bateria optimizazioak"),
        ("android_open_battery_optimizations_tip", "Ezaugarri hau desgaitu nahi baduzu, joan zaitez HesabDesk aplikazioaren ezarpen orrira, bilatu eta saltu [Bateria] orrira eta kendu [Mugarik gabe]"),
        ...
        ("Show HesabDesk", "Erakutsi HesabDesk"),
        ("This PC", "PC hau"),
        ("or", "edo"),
        ("Elevate", "Igo maila"),
        ...
        ("config_input", "Urruneko mahaigaina teklatuaren bidez kontrolatzeko, HesabDesk-i \"Sarrera monitorizazioa\" baimena eman behar diozu."),
        ("config_microphone", "Urrunetik hitz egin ahal izateko, HesabDeski-i \"Grabatu audioa\" baimena eman behar diozu."),
        ...
        ("still_click_uac_tip", "Oraindik beharrezkoa da urruneko erabiltzaileak Ondo botoiari klik egitea exekutatzen ari den HesabDesk UAC leihoan"),
        ...
        ("verify_hesabdesk_password_tip", "Berretsi HesabDesk pasahitza"),
        ...
        ("scam_text1", "Ezagutzen eta fidatzen EZ duzun norbaitekin telefonoz bazaude eta HesabDesk erabiltzeko eta zerbitzua abiarazteko eskatu badizute, ez ezazu egin eta eskegi berehala."),
        ...
        ("upgrade_hesabdesk_server_pro_to_{}_tip", "Mesedez, bertsio-berritu HesabDesk Server Pro {} bertsiora edo berriago batera!"),
        ...
        ("selinux_tip", "SELinux zure gailuan gaituta dago. Honek HesabDesk kontrolatutako alde gisa dagoenean behar bezala ez exekutatzea ekarri dezake."),
        ...
        ("powered_by_me", "HesabDesk-ek egina"),
        ...
        ("allow-only-conn-window-open-tip", "Baimendu konexioa HesabDesk leihoa irekita badago"),
        ...
        ("floating_window_tip", "HesabDesk atzeko planoko zerbitzua mantentzen laguntzen du"),
        ...
        ("About HesabDesk", "HesabDesk-i buruz"),
        ...
        ("upgrade_remote_hesabdesk_client_to_{}_tip", "Mesedez, eguneratu HesabDesk bezeroa {} bertsiora edo berriagoa urruneko aldean!"),
        ...
        ("allow-insecure-tls-fallback-tip", "Modu lehenetsian, HesabDesk-ek zerbitzariaren ziurtagiria egiaztatzen du TLS erabiltzen duten protokoloetarako.\nAukera hau gaituta dagoela, HesabDesk-ek egiaztapen-urratsa saltatzera joko du eta aurrera egingo du egiaztapenak huts eginez gero."),
        ("Disable UDP", "Desgaitu UDP"),
        ("disable-udp-tip", "TCP soilik erabiliko den kontrolatzen du.\nAukera hau gaituta dagoenean, HesabDesk-ek ez du gehiago UDP 21116 erabiliko; horren ordez, TCP 21116 erabiliko da."),
        ("server-oss-not-support-tip", "OHARRA: HesabDesk zerbitzariaren OSS bertsioak ez du ezaugarri hau barne hartzen."),
        ...
        ("HesabDesk cannot reach the desktop session on the remote device, check that a desktop session is running and that HesabDesk can use it", "HesabDesk-ek ezin du urruneko gailuko mahaigaineko saioa atzitu, egiaztatu saio bat martxan dagoela eta HesabDesk-ek erabil dezakeela"),
        ...
        ("HesabDesk could not obtain a usable screen from the XDG Desktop Portal, the PipeWire library may be too old", "HesabDesk-ek ezin izan du pantaila erabilgarririk lortu XDG Desktop Portal-etik, PipeWire liburutegia zaharregia izan daiteke"),
        ("HesabDesk could not load a GStreamer component needed for screen capture ({})", "HesabDesk-ek ezin izan du pantaila kapturatzeko beharrezkoa den GStreamer osagai bat kargatu ({})"),
