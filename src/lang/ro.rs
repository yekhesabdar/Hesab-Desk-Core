...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "În curs de conectare la rețeaua HesabDesk..."),
        ...
        ("install_tip", "Din cauza restricțiilor CCU, este posibil ca HesabDesk să nu funcționeze corespunzător. Pentru a evita acest lucru, dă clic pe butonul de mai jos pentru a instala HesabDesk."),
        ("Click to upgrade", "Dă clic pentru a face upgrade"),
        ("Configure", "Configurează"),
        ("config_acc", "Pentru a controla desktopul la distanță, trebuie să permiți HesabDesk acces la setările de Accesibilitate."),
        ("config_screen", "Pentru a controla desktopul la distanță, trebuie să permiți HesabDesk acces la setările de Înregistrare ecran."),
        ...
        ("android_input_permission_tip1", "Pentru ca un dispozitiv la distanță să poată controla un dispozitiv Android folosind mouse-ul sau suportul tactil, trebuie să permiți HesabDesk să utilizeze serviciul „Accesibilitate\"."),
        ("android_input_permission_tip2", "Accesează următoarea pagină din Setări, deschide [Aplicații instalate] și pornește serviciul [HesabDesk Input]."),
        ...
        ("Turned off", "Închis"),
        ("Language", "Limbă"),
        ("Keep HesabDesk background service", "Rulează serviciul HesabDesk în fundal"),
        ("Ignore Battery Optimizations", "Ignoră optimizările de baterie"),
        ("android_open_battery_optimizations_tip", "Pentru dezactivarea acestei funcții, accesează setările aplicației HesabDesk, deschide secțiunea [Baterie] și deselectează [Fără restricții]."),
        ...
        ("Show HesabDesk", "Afișează HesabDesk"),
        ("This PC", "Acest PC"),
        ("or", "sau"),
        ...
        ("config_input", "Pentru a controla desktopul la distanță folosind tastatura, trebuie să acorzi HesabDesk permisiunea Monitorizare intrare"),
        ("config_microphone", "Pentru a desfășura un apel vocal, este nevoie să acorzi HesabDesk permisiunea Înregistrare audio."),
        ...
        ("still_click_uac_tip", "Este necesar ca utilizatorul la distanță să confirme în fereastra CCU din HesabDesk care rulează."),
        ...
        ("verify_hesabdesk_password_tip", "Verifică parola HesabDesk"),
        ...
        ("scam_text1", "Escrocii se pot da drept angajați ai asistenței tehnice și îți pot solicita să instalezi sau să rulezi HesabDesk pentru a-ți accesa dispozitivul."),
        ...
        ("upgrade_hesabdesk_server_pro_to_{}_tip", "Versiunea serverului HesabDesk Pro este mai mică decât {}. Te rugăm să o actualizezi."),
        ...
        ("input_source_2_tip", "Sursă de intrare 2 — folosește driver-ul HesabDesk pentru simulare la nivel de kernel"),
        ...
        ("powered_by_me", "Realizat cu HesabDesk"),
        ...
        ("ab_web_console_tip", "Gestionează agenda prin consola web HesabDesk Pro."),
        ...
        ("enable-bot-desc", "Configurează un bot Telegram pentru notificări HesabDesk. Introdu token-ul botului și ID-ul chat-ului."),
        ...
        ("About HesabDesk", "Despre HesabDesk"),
        ...
        ("web_id_input_tip", "Introdu ID-ul HesabDesk al dispozitivului la care vrei să te conectezi"),
        ("Download", "Descarcă"),
        ...
        ("upgrade_remote_hesabdesk_client_to_{}_tip", "Versiunea clientului HesabDesk de la distanță este mai mică decât {}. Te rugăm să o actualizezi pentru o compatibilitate completă."),
        ...
        ("server-oss-not-support-tip", "Serverul open-source nu suportă această funcție. Folosește HesabDesk Pro pentru funcționalitate completă."),
        ...
        ("HesabDesk cannot reach the desktop session on the remote device, check that a desktop session is running and that HesabDesk can use it", "HesabDesk nu poate accesa sesiunea de desktop de pe dispozitivul de la distanță, verificați dacă o sesiune rulează și dacă HesabDesk o poate folosi"),
        ...
        ("HesabDesk could not obtain a usable screen from the XDG Desktop Portal, the PipeWire library may be too old", "HesabDesk nu a putut obține un ecran utilizabil de la XDG Desktop Portal, biblioteca PipeWire poate fi prea veche"),
        ("HesabDesk could not load a GStreamer component needed for screen capture ({})", "HesabDesk nu a putut încărca o componentă GStreamer necesară pentru capturarea ecranului ({})"),
