...
///
/// Note:
/// On linux, we use dbus to communicate between multiple hesabdesk processes.
...
const DBUS_NAME: &str = "org.hesabdesk.hesabdesk";
...
impl fmt::Display for DbusError {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        write!(f, "HesabDesk DBus Error: {}", self.0)
    }
}
...
/// `dbus-send --session --print-reply --dest=org.hesabdesk.hesabdesk /dbus org.hesabdesk.hesabdesk.NewConnection string:'PEER_ID'`
