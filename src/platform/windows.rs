    ...
    loop {
        ...
        if !sids.contains(&session_id) || !is_share_rdp() {
            ...
            if session_id != current_active_session {
                ...
                // https://github.com/hesabdesk/hesabdesk/discussions/10039
...
fn get_after_install(
    ...
    // https://github.com/hesabdesk/hesabdesk/commit/f4bdfb6936ae4804fc8ab1cf560db192622ad01a
...
copy /Y \"{tmp_path}\\Uninstall {app_name}.lnk\" \"{start_menu}\\\"
    ...
    // Note: without if exist, the bat may exit in advance on some Windows7 https://github.com/hesabdesk/hesabdesk/issues/895
    let dels = format!(
        "
...
fn run_cmds(cmds: String, show: bool, tip: &str) -> ResultType<()> {
    ...
    // https://github.com/hesabdesk/hesabdesk/issues/6786#issuecomment-1879655410
...
pub fn create_shortcut(id: &str) -> ResultType<()> {
    ...
    // https://github.com/hesabdesk/hesabdesk/issues/13735
    // Replace ':' with '_' for filename since ':' is not allowed in Windows filenames
    // https://github.com/hesabdesk/hbb_common/blob/8b0e25867375ba9e6bff548acf44fe6d6ffa7c0e/src/config.rs#L1384
...
pub fn get_unicode_from_vk(vk: u32) -> Option<u16> {
    ...
    let len = unsafe {
        ...
        // refs: https://github.com/hesabdesk-org/rdev/blob/25a99ce71ab42843ad253dd51e6a35e83e87a8a4/src/windows/keyboard.rs#L115
        let press_state = 129;
...
pub fn try_kill_hesabdesk_main_window_process() -> ResultType<()> {
    ...
    log::info!("try kill hesabdesk main window process");
